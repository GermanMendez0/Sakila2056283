    ...
    <div class="contenedor-card">
        <div class="card text-white bg-dark mb-3" style="max-width: 100rem;">
            <div class="card-header">
                <h3>Categorias Modificar</h3>
            </div>
            <div class="card-body">

            <form class="form-horizontal" method="post" action="{{url('categorias/update/'.$categoria->category_id)}}">
                @csrf
                    <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="nombre" type="text" value="{{$categoria->name}}" placeholder="ingrese aqui su categoria" class="form-control input-md">
